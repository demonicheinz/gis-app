...
(function (global, factory) {
    ...
    var getFocusableElements = function getFocusableElements() {
        ...
        var otherFocusableElementsFiltered = Array.from(otherFocusableElements).filter(
            function (el) {
    ...
    function renderButton(button, buttonType, params) {
        var buttonName =
            /** @type {'Confirm' | 'Deny' | 'Cancel'} */ capitalizeFirstLetter(buttonType);
    ...
    var clickDeny = function clickDeny() {
        ...
        return (_dom$getDenyButton = getDenyButton()) === null || _dom$getDenyButton === void 0
            ? void 0
