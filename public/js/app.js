...
*/ (function () {
                ...
                "./node_modules/core-js/internals/create-iterator-constructor.js": function (
                    ...
                    s.exports = function (m, E, A) {
                        var _ = E + " Iterator";
                        return (
                            (m.prototype = a(l, { next: u(1, A) })), p(m, _, !1, !0), (h[_] = g), m
                        );
                    };
                },
                ...
                "./node_modules/core-js/internals/define-iterator.js": function (s, f, r) {
                    ...
                    s.exports = function ($, H, ue, yt, Te, rn, Nt) {
                        ...
                        if (
                            ...
                            if (
                                ((Se = { values: Oe(L), keys: rn ? ge : Oe(S), entries: Oe(W) }),
                                Nt)
                            )
        ...
        (function (s, f) {
            ...
            const an = n => {
                ...
                Dt = (n, e = "hide") => {
                    ...
                    x.on(document, t, `[data-bs-dismiss="${i}"]`, function (o) {
                        if ((["A", "AREA"].includes(this.tagName) && o.preventDefault(), v(this)))
                            return;
            ...
            class It extends gt {
                ...
                _eventIsPointerPenTouch(e) {
                    return (
                        this._supportPointerEvents && (e.pointerType === Qr || e.pointerType === Xr)
                    );
                }
                static isSupported() {
                    return (
            ...
            const to = "carousel",
                ...
                Ao = { [no]: $t, [io]: et },
                jo = { interval: 5e3, keyboard: !0, pause: "hover", ride: !1, touch: !0, wrap: !0 },
                wo = {
            ...
            function dt(n, e) {
                ...
                var t = e,
                    ...
                    G = Ai({ reference: K, element: Q, strategy: "absolute", placement: o }),
            ...
            function ss(n, e) {
                ...
                var N = P.reduce(function (B, R) {
                    return (
                        (B[R] = dt(n, { placement: R, boundary: o, rootBoundary: c, padding: d })[
                            xe(R)
                        ]),
                        B
                    );
            ...
            const wn = { name: "popperOffsets", enabled: !0, phase: "read", fn: ps, data: {} };
            function hs(n) {
                return n === "x" ? "y" : "x";
            }
            function fs(n) {
                var e = n.state,
                    ...
                    B = t.tetherOffset,
                    R = B === void 0 ? 0 : B,
                    z = dt(e, { boundary: b, rootBoundary: M, padding: I, altBoundary: j }),
                    Y = xe(e.placement),
                    X = ct(e.placement),
                    Q = !X,
                    V = vn(Y),
            ...
            class zi extends gt {
                ...
                dispose() {
                    this._isAppended &&
                        (x.off(this._element, ki), this._element.remove(), (this._isAppended = !1));
                }
                _getElement() {
                    if (!this._element) {
            ...
            const da = "modal",
                ...
                Oa = { backdrop: "(boolean|string)", focus: "boolean", keyboard: "boolean" };
            class He extends he {
                constructor(e, t) {
                    super(e, t),
            ...
            const Sa = "offcanvas",
                ...
                ka = { backdrop: "(boolean|string)", keyboard: "boolean", scroll: "boolean" };
            class we extends he {
                constructor(e, t) {
                    super(e, t),
                        (this._isShown = !1),
            ...
            const Ba = "TemplateFactory",
                ...
                Ua = { entry: "(string|element|function|null)", selector: "(string|element)" };
            class Xa extends gt {
                constructor(e) {
            ...
            class ke extends he {
                ...
                show() {
                    ...
                    if (
                        (this._element.ownerDocument.documentElement.contains(this.tip) ||
                            (c.append(o), x.trigger(this._element, this.constructor.eventName(sl))),
                ...
                hide() {
                    if (
                        !this._isShown() ||
                        x.trigger(this._element, this.constructor.eventName(nl)).defaultPrevented
                    )
                        return;
                    if (
