...
export interface Api<T> {
    ...
    iterator(
        flatten: boolean,
        type: "column-rows",
        callback: InteratorColumnRows,
        returns: boolean
    ): Api<any>;
    iterator(
        flatten: boolean,
        type: "column",
        callback: InteratorColumn,
        returns: boolean
    ): Api<any>;
    iterator(
        flatten: boolean,
        type: "columns",
        callback: InteratorColumns,
        returns: boolean
    ): Api<any>;
     ...
     */
    reduce(
        fn: (current: number, value: any, index: number, dt: Api<any>) => number,
        initialValue?: any
    ): any;
...
export interface ApiColumnsMethods {
     ...
     */
    every(
        fn: (this: ApiColumnMethods, colIdx: number, tableLoop: number, colLoop: number) => void
    ): Api<any>;
...
export interface ApiRowsMethods<T> extends Api<T> {
     ...
     */
    every(
        fn: (this: ApiRowMethods<T>, rowIdx: number, tableLoop: number, rowLoop: number) => void
    ): Api<any>;
